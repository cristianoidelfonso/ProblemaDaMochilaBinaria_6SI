...
public class AlgoritmoGenetico {
    ...
    //--------------------------------------------------------------------------
    public void inicializaPopulacao(List pesos, List valores, Double limitePeso){
    ...
    //--------------------------------------------------------------------------
    public List resolver(Double taxaMutacao, int numeroGeracao, List pesos, List valores, Double limitePeso ){
